const THEME_KEY = 'ee-pro-theme';
const SECTION_KEY = 'ee-pro-section';
const TOOL_KEY = 'ee-pro-tool';
const SAVE_KEY = 'ee-pro-saved-tools';
...
$('exportState').onclick = () => {
  ...
  const a = document.createElement('a'); a.href = URL.createObjectURL(blob); a.download = 'ee-toolbox-pro-state.json'; a.click(); URL.revokeObjectURL(a.href);
  report('Project Export', 'Downloaded local state snapshot');
};
